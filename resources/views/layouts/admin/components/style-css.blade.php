 ...
 <!-- Linear Icon css -->
 <link rel="stylesheet" href="{{ url('/assets') }}/css/linearicon.css">
 ...
 <!-- ratio css -->
 <link rel="stylesheet" type="text/css" href="{{ url('/assets') }}/css/ratio.css">
 ...
 <!-- Slick Slider Css -->
 <link rel="stylesheet" href="{{ url('/assets') }}/css/vendors/slick.css">
